...
The 6,042 original workbook records plus verified dated additions are included under `app/data`. New jobs and edits are stored in Neon and automatically override the matching imported record for every signed-in member.
